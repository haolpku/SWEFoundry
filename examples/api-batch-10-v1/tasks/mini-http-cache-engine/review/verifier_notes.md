...
- `1-canonicalize-requests-and-responses`: 9
- `2-evaluate-freshness-and-stale-policy`: 9
- `3-merge-conditional-304-responses`: 8
- `4-apply-invalidation-rules`: 8
- `5-integrated-cache-audit-and-recovery`: 9
