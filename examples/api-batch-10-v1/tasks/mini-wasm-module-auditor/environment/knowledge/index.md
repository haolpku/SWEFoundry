...
`mini-wasm-module-auditor`. It is agent-visible at `/app/knowledge` and is the authoritative
...
The task is a concept study informed by https://github.com/WebAssembly/spec, licensed as
Apache-2.0. No upstream implementation code or proprietary data was
