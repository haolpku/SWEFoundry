...
`mini-dns-zone-auditor`. It is agent-visible at `/app/knowledge` and is the authoritative
...
The task is a concept study informed by https://www.rfc-editor.org/rfc/rfc1035, licensed as
