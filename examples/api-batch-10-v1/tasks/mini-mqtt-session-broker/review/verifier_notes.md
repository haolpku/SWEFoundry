...
verifiers. It confirmed 42 named cases:

- `1-parse-broker-events`: 8
- `2-match-wildcard-subscriptions`: 9
- `3-replay-qos-and-retained-state`: 8
- `4-plan-session-migration`: 8
- `5-integrated-broker-replay-recovery`: 9
