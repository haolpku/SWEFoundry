...
`mini-systemd-unit-linter`. It is agent-visible at `/app/knowledge` and is the authoritative
...
The task is a concept study informed by https://github.com/systemd/systemd, licensed as
LGPL-2.1-or-later. No upstream implementation code or proprietary data was
