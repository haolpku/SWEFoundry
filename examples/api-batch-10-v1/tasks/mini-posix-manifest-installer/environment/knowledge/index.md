...
`mini-posix-manifest-installer`. It is agent-visible at `/app/knowledge` and is the authoritative
...
The task is a concept study informed by https://pubs.opengroup.org/onlinepubs/9699919799/functions/rename.html, licensed as
Open Group Base Specifications Issue 7 terms. No upstream implementation code or proprietary data was
