...
`mini-ical-sync-engine`. It is agent-visible at `/app/knowledge` and is the authoritative
...
The task is a concept study informed by https://www.rfc-editor.org/rfc/rfc5545, licensed as
